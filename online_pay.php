...
<body style="background: url('uploads/whi.jpg');background-repeat: no-repeat;text-align: center; background-size:cover;font-size: 20px  ">
<h1 style="text-align:center;color:blue">WELCOME TO MY BANK PAYMENT GATEWAY</h1>
<pre>
...
</select>  <select name="edate" id="edate">
...
Enter Captcha Code      <input type="text" id="captcha" name="captcha"><br>
